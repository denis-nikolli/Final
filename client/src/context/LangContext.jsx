...
const translations = {
    en: {
        ...
        about: {
            ...
            whoDesc: "Car Rental helps visitors move between Tirana Airport, Durres, Vlore, Sarande, and the mountain routes with clean cars, clear pricing, and practical route advice from a local team.",
    ...
    al: {
        ...
        about: {
            ...
            whoDesc: "Car Rental ndihmon vizitorët të lëvizin midis Aeroportit të Tiranës, Durrësit, Vlorës, Sarandës dhe rrugëve malore me makina të pastra, çmime të qarta dhe këshilla praktike rrugësh nga një ekip lokal.",
